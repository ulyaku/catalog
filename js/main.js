...
document.addEventListener('DOMContentLoaded', function () {
  ...
  set('home-methods-title',   SITE_HOME.sections.methods_title);
  set('home-methods-sub',     SITE_HOME.sections.methods_sub);
  set('home-audiences-title', SITE_HOME.sections.audiences_title);
  set('home-audiences-sub',   SITE_HOME.sections.audiences_sub);

  // Method section headers
  set('method-steps-title',   SITE_METHOD.sections.steps_title);
  set('method-steps-sub',     SITE_METHOD.sections.steps_sub);
  set('method-belief-title',  SITE_METHOD.sections.belief_title);
  set('method-pricing-title', SITE_METHOD.sections.pricing_title);
  set('method-pricing-sub',   SITE_METHOD.sections.pricing_sub);

  // Games section header
  set('games-title', SITE_GAMES.sections.title);
  set('games-sub',   SITE_GAMES.sections.sub);
